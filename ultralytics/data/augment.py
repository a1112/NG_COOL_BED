...
class Compose:
    ...
    def __init__(self, transforms):
        ...
        Examples:
            >>> from ultralytics import Compose, RandomHSV, RandomFlip
...
class Mosaic(BaseMixTransform):
    ...
    Examples:
        >>> from ultralytics import Mosaic
...
class RandomHSV:
    ...
    Examples:
        >>> import numpy as np
        >>> from ultralytics import RandomHSV
...
class CopyPaste(BaseMixTransform):
    ...
    Examples:
        >>> from ultralytics import CopyPaste
        >>> dataset = YourDataset(...)  # Your image dataset
...
def v8_transforms(dataset, imgsz, hyp, stretch=False):
    ...
    Examples:
        >>> from ultralytics import YOLODataset
        >>> from ultralytics import IterableSimpleNamespace
